...
````sh
edit-cfg-json-textual --module myapp.config AppConfig -i /etc/myapp.json
````
...
````sh
edit-cfg-json-textual --module myapp.config AppConfig -i /etc/myapp.json
edit-cfg-json-textual --file ./somewhere/cfg.py AppConfig
````
...
````sh
python3 -m edit_cfg_json_textual --module myapp.config AppConfig
````
