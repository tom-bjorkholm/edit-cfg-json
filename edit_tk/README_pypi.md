...
| 3 | `~/.edit-cfg-json-tk.cfg`, which only this program reads. |
...
````sh
edit-cfg-json-tk -c ./myapp-editor.cfg --module myapp.config --class AppConfig \
    -i /etc/myapp.cfg
````
...
````sh
edit-cfg-json-tk --edit-settings -o ~/.edit-cfg-json-tk.cfg
edit-cfg-json-tk --edit-settings -i ~/.edit-cfg-json-tk.cfg
````
