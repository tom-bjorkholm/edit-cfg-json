...
* [edit\_cfg\_json\_tk.tk\_editor](#edit_cfg_json_tk.tk_editor)
  ...
  * [EditorWidgets](#edit_cfg_json_tk.tk_editor.EditorWidgets)
    ...
    * [\_searched](#edit_cfg_json_tk.tk_editor.EditorWidgets._searched)
    * [\_reach\_found](#edit_cfg_json_tk.tk_editor.EditorWidgets._reach_found)
    * [\_show\_found](#edit_cfg_json_tk.tk_editor.EditorWidgets._show_found)
    ...
    * [\_choose](#edit_cfg_json_tk.tk_editor.EditorWidgets._choose)
    * [\_show\_choices](#edit_cfg_json_tk.tk_editor.EditorWidgets._show_choices)
    * [\_show\_values](#edit_cfg_json_tk.tk_editor.EditorWidgets._show_values)
...
* [edit\_cfg\_json\_tk.tk\_find](#edit_cfg_json_tk.tk_find)
  ...
  * [FindPanel](#edit_cfg_json_tk.tk_find.FindPanel)
    ...
    * [\_options](#edit_cfg_json_tk.tk_find.FindPanel._options)
...
* [edit\_cfg\_json\_tk.tk\_scope](#edit_cfg_json_tk.tk_scope)
  ...
  * [\_key\_handler](#edit_cfg_json_tk.tk_scope._key_handler)
  * [KeyScope](#edit_cfg_json_tk.tk_scope.KeyScope)
    ...
    * [\_reach](#edit_cfg_json_tk.tk_scope.KeyScope._reach)
...
* [edit\_cfg\_json\_tk.tk\_values](#edit_cfg_json_tk.tk_values)
  * [ValueWidgets](#edit_cfg_json_tk.tk_values.ValueWidgets)
    ...
    * [\_made\_chooser](#edit_cfg_json_tk.tk_values.ValueWidgets._made_chooser)
    ...
    * [\_write\_field](#edit_cfg_json_tk.tk_values.ValueWidgets._write_field)
    * [\_left\_field](#edit_cfg_json_tk.tk_values.ValueWidgets._left_field)
...
```python
def _add_buttons(parent: tkinter.Misc, explained: tkinter.BooleanVar,
...
<a id="edit_cfg_json_tk.tk_editor.EditorWidgets._searched"></a>
...
<a id="edit_cfg_json_tk.tk_editor.EditorWidgets._reach_found"></a>
...
<a id="edit_cfg_json_tk.tk_editor.EditorWidgets._show_found"></a>
...
<a id="edit_cfg_json_tk.tk_editor.EditorWidgets._choose"></a>
...
<a id="edit_cfg_json_tk.tk_editor.EditorWidgets._show_choices"></a>
...
<a id="edit_cfg_json_tk.tk_editor.EditorWidgets._show_values"></a>

#### \_show\_values

```python
def _show_values() -> None
```
...
<a id="edit_cfg_json_tk.tk_tooltip.Tooltip._shower"></a>

#### \_shower

```python
def _shower() -> Callable[..., None]
```

Return the callback that the pointer arriving runs.

<a id="edit_cfg_json_tk.tk_tooltip.Tooltip._hider"></a>

#### \_hider

```python
def _hider() -> Callable[..., None]
```

Return the callback that the pointer leaving runs.

<a id="edit_cfg_json_tk.tk_tooltip.Tooltip._show"></a>

#### \_show

```python
def _show(event: Optional['tkinter.Event[tkinter.Misc]']) -> None
```
...
<a id="edit_cfg_json_tk.tk_find.FindPanel._add_entry"></a>

#### \_add\_entry

```python
def _add_entry(parent: tkinter.Misc, text: tkinter.StringVar) -> tkinter.Entry
```
...
<a id="edit_cfg_json_tk.tk_find.FindPanel._add_ticks"></a>

#### \_add\_ticks

```python
def _add_ticks(parent: tkinter.Misc,
               options: core.FindOptions) -> tuple[tkinter.BooleanVar, ...]
```
...
<a id="edit_cfg_json_tk.tk_find.FindPanel._add_tick"></a>

#### \_add\_tick

```python
def _add_tick(parent: tkinter.Misc, label: str, tip: str,
...
```python
def _typed(text: tkinter.StringVar) -> Callable[..., None]
```
...
<a id="edit_cfg_json_tk.tk_find.FindPanel._entered"></a>

#### \_entered

```python
def _entered(*event: 'tkinter.Event[tkinter.Misc]') -> None
```
...
<a id="edit_cfg_json_tk.tk_find.FindPanel._toggled"></a>
...
<a id="edit_cfg_json_tk.tk_find.FindPanel._options"></a>
...
<a id="edit_cfg_json_tk.tk_scope._scope_numbers"></a>

#### \_scope\_numbers

What makes the name of each tag different from every other one.

<a id="edit_cfg_json_tk.tk_scope._key_handler"></a>
...
<a id="edit_cfg_json_tk.tk_scope.KeyScope._reach"></a>

#### \_reach

```python
def _reach(widget: tkinter.Misc) -> None
```
...
<a id="edit_cfg_json_tk.tk_values.ValueWidgets._made_chooser"></a>

#### \_made\_chooser

```python
def _made_chooser(row: core.MemberRow) -> Optional[tkinter.Menubutton]
```
...
<a id="edit_cfg_json_tk.tk_values.ValueWidgets._write_field"></a>

#### \_write\_field

```python
def _write_field(*trace_arguments: str) -> None
```
...
<a id="edit_cfg_json_tk.tk_values.ValueWidgets._left_field"></a>

#### \_left\_field

```python
def _left_field(*event: 'tkinter.Event[tkinter.Misc]') -> None
```
